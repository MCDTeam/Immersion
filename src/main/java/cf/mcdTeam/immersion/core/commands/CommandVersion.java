package cf.mcdTeam.immersion.core.commands;

import net.minecraft.command.ICommandSender;
import net.minecraft.command.WrongUsageException;
import net.minecraft.util.ChatComponentText;
import cf.mcdTeam.immersion.core.meta.Commands;
import cf.mcdTeam.immersion.coreFeatures.versionCheck.VersionHelper;
