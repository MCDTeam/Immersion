...
public class ConfigLoad 
{
	...
	public static Boolean OREGEMDIAMONDGENERATE = true;
	public static int OREGEMDIAMONDYMIN = 4;
	public static int OREGEMDIAMONDYMAX = 12;
	public static int OREGEMDIAMONDCHUNKDENSITY = 4;
	public static int OREGEMDIAMONDGENERATEMIN = 4;
	public static int OREGEMDIAMONDGENERATEMAX = 12;
	
	public static Boolean OREGEMEMERALDGENERATE = true;
	public static int OREGEMEMERALDYMIN = 4;
	public static int OREGEMEMERALDYMAX = 12;
	public static int OREGEMEMERALDCHUNKDENSITY = 4;
	public static int OREGEMEMERALDGENERATEMIN = 4;
	public static int OREGEMEMERALDGENERATEMAX = 12;
