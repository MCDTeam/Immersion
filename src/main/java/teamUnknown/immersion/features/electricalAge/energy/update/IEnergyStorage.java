...
public interface IEnergyStorage {
    ...
    /**
     * Returns if energy can be be added.
     * @param amount The amount of energy that is being tried to add.
     */
    boolean canAddEnergy(int amount);

    /**
     * Returns if energy can be be removed.
